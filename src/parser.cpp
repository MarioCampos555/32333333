...
void Parser::procedureR1() {
    outputFile << "<Rat23F> ::= <Opt Function Definitions> # <Opt Declaration List> # <Statement List>" << std::endl;
...
void Parser::procedureR29() {
    outputFile << "<While> ::= while ( <Condition> ) <Statement>" << std::endl;
